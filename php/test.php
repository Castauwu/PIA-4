...
<link rel="stylesheet" href="css/bienvenido2.css">
</head>
<body>
  ...
  <div>
    ...
    <div class="p1" onclick="location.href='vyb.php'"><h1 >USO DE LA B Y V</h1></div>
    <div class="p2"><h1>COMO TILDAR </h1></div>
    <div class="p3"><h1>PALABRAS HOMÓNIMAS<br>(No disponible)</h1></div>
    <div class="p4"><h1>USO DE Y y LL</h1></div>
    <div class="p5"><h1>USO DE C X S Z</h1></div>                      
<!-- partial -->
